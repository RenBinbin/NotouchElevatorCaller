...
public class UserInfoBean {
    ...
    /**
     * result : 1
     * msg : {"_id":8892,"_bianhao":"1006177","_account":"1006177","_pwd":"C6994BFECF88E9E1","_secre_key":"VJ4T","_user_type":1,"_realname":"任斌斌","_realname_spell":"RenBinBin","_sub_name":"","_role_id":null,"_organize_id":null,"_sex":1,"_title":"1","_email":"renbinbin@canny-elevator.com","_phone":"13621566571","_caption":"cn=任斌斌,ou=KL_智能部件研发部,ou=康力电梯股份有限公司,ou=康力集团,dc=canny-elevator,dc=com","_enabled":1,"_single_login":0,"_mobile_login":1,"_is_limitip":0,"_is_alarm":1,"_is_sys":1,"_create_time":"2017-07-01T10:45:09","_create_userid":0,"_remark":"Android","_field_1":"","_field_2":"","_field_3":"","_open_id":"Cannya00000552e111e"}
     */
    ...
    private Object _role_id;
    private Object _organize_id;
    private int _sex;
    ...
    public Object get_role_id() {
        return _role_id;
    }

    public void set_role_id(Object _role_id) {
        this._role_id = _role_id;
    }

    public Object get_organize_id() {
        return _organize_id;
    }

    public void set_organize_id(Object _organize_id) {
        this._organize_id = _organize_id;
    }
